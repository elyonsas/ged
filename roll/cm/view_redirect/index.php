...
if (isset($_GET['action'])) {
    ...
    if ($_GET['action'] == 'view_collaborateur') {
        ...
        header('Location: /ged/roll/cm/collaborateurs/view');
    }
    ...
    if ($_GET['action'] == 'view_client') {
        ...
        header('Location: /ged/roll/cm/dossiers/view');
    }
    ...
    if ($_GET['action'] == 'view_saisie_client') {
        ...
        header('Location: /ged/roll/cm/saisies-clients/view');
    }
    ...
    if ($_GET['action'] == 'view_of_stat_saisie') {
        ...
        header('Location: /ged/roll/cm/saisies-clients/?data_client=true');
    }
    ...
    if ($_GET['action'] == 'view_of_secteur_activite') {
        ...
        header('Location: /ged/roll/cm/dossiers/?data_client=true');
    }
    ...
    if ($_GET['action'] == 'view_facture') {
        ...
        header('Location: /ged/roll/cm/comptabilite/facture/view');
    }
}
