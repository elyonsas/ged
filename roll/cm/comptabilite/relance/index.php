...
<script>
    $(document).ready(function() {
        ...
        function reload_page() {
            ...
            $.ajax({
                url: "roll/cm/comptabilite/relance/fetch.php",
                method: "POST",
                data: {
