            ...
            data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Tableau de bord', $icon, 'roll/cm', $menu_tb) ?>
                    <!--end:Menu item-->
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Dossiers de travail', $icon, 'roll/cm/dossiers', $menu_dt) ?>
                    <!--end:Menu item-->
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Interlocuteurs', $icon, 'roll/cm/interlocuteurs', $menu_interlo) ?>
                    <!--end:Menu item-->
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Collaborateurs', $icon, 'roll/cm/collaborateurs', $menu_collabo) ?>
                    <!--end:Menu item-->
                    ...
                    [
                        ['Factures client', 'roll/cm/comptabilite/facture', $menu_compta_facture],
                        ['Relance client', 'roll/cm/comptabilite/relance', $menu_compta_relance],
                    ...
                    [
                        ['Interlocuteur', 'roll/cm/historique/interlocuteur', $menu_hist_interlo],
                        ['Collaborateur', 'roll/cm/historique/collaborateur', $menu_hist_collabo],
