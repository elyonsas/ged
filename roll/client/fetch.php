    ...
    if ($_POST['datatable'] == 'secteur_activite_client') {
        ...
        foreach ($result as $row) {
            ...
            $sub_array[] = <<<HTML
                ...
                <a class="text-dark text-underline-hover" href="roll/client/view_redirect/?action=view_of_secteur_activite&id_secteur_activite={$id_secteur_activite}" style="font-size: 13.975px;">$nbr_client client$end_s</a>
            HTML;
