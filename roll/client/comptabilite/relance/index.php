...
<script>
    $(document).ready(function() {
        ...
        function reload_page() {
            ...
            $.ajax({
                url: "roll/client/comptabilite/relance/fetch.php",
                method: "POST",
                data: {
