...
add_log('consultation', 'Consultation du tableau de bord Client', $_SESSION['id_utilisateur'], $db);
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											...
											<span class="text-gray-900 fw-bolder fs-6"><?= stat_mois_client_a_jour($db) ?> 
												<a class="text-dark" href="roll/client/view_redirect/?action=view_of_stat_saisie&date=">
													clients à jour
												</a>
											</span>
											<!--end::Number-->
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											...
											<span class="text-gray-900 fw-bolder fs-6"><?= stat_mois_client_a_jour($db, date('Y-m', strtotime('-1 month'))) ?> 
												<a class="text-dark" href="roll/client/view_redirect/?action=view_of_stat_saisie&date=<?=date('Y-m', strtotime('-1 month'))?>">
													clients à jour
												</a>
											</span>
											<!--end::Number-->
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											...
											<span class="text-gray-900 fw-bolder fs-6"><?= stat_mois_client_a_jour($db, date('Y-m', strtotime('-2 month'))) ?>  
												<a class="text-dark" href="roll/client/view_redirect/?action=view_of_stat_saisie&date=<?=date('Y-m', strtotime('-2 month'))?>">
													clients à jour
												</a>
											</span>
											<!--end::Number-->
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											...
											<span class="text-gray-900 fw-bolder fs-6"><?= stat_mois_client_a_jour($db, date('Y-m', strtotime('-3 month'))) ?> 
												<a class="text-dark" href="roll/client/view_redirect/?action=view_of_stat_saisie&date=<?=date('Y-m', strtotime('-3 month'))?>">
													clients à jour
												</a>
											</span>
											<!--end::Number-->
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											...
											<span class="text-gray-900 fw-bolder fs-6"><?= stat_mois_client_a_jour($db, date('Y-m', strtotime('-4 month'))) ?> 
												<a class="text-dark" href="roll/client/view_redirect/?action=view_of_stat_saisie&date=<?=date('Y-m', strtotime('-4 month'))?>">
													clients à jour
												</a>
											</span>
											<!--end::Number-->
