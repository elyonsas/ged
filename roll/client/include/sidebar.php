            ...
            data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Dossiers de travail', $icon, 'roll/client/dossiers', $menu_dt) ?>
                    <!--end:Menu item-->
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Collaborateurs', $icon, 'roll/client/collaborateurs', $menu_collabo) ?>
                    <!--end:Menu item-->
                    ...
                    $icon = <<<HTML
                            ...
                            HTML;
                    ?>
                    <?= single_menu('Saisies clients', $icon, 'roll/client/saisies-clients', $menu_saisie_client) ?>
                    <!--end:Menu item-->
                    ...
                    [
                        ['Factures client', 'roll/client/comptabilite/facture', $menu_compta_facture],
                        ['Relance client', 'roll/client/comptabilite/relance', $menu_compta_relance],
                    ...
                    [
                        ...
                        ['Collaborateur', 'roll/client/historique/collaborateur', $menu_hist_collabo],
