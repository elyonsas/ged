...
if (isset($_GET['action'])) {
    ...
    if ($_GET['action'] == 'view_collaborateur') {
        ...
        header('Location: /roll/ag/collaborateurs/view');
    }
    ...
    if ($_GET['action'] == 'view_client') {
        ...
        header('Location: /roll/ag/dossiers/view');
    }
    ...
    if ($_GET['action'] == 'view_saisie_client') {
        ...
        header('Location: /roll/ag/saisies-clients/view');
    }
    ...
    if ($_GET['action'] == 'view_of_stat_saisie') {
        ...
        header('Location: /roll/ag/saisies-clients/?data_client=true');
    }
    ...
    if ($_GET['action'] == 'view_of_secteur_activite') {
        ...
        header('Location: /roll/ag/dossiers/?data_client=true');
    }
    ...
    if ($_GET['action'] == 'view_facture') {
        ...
        header('Location: /roll/ag/comptabilite/facture/view');
    }
}
