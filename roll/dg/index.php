						...
						<div class="card card-flush min-h-225px">
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									...
									<!--end::Info-->
									<!--begin::Subtitle-->
									<span class="text-dark pt-1 fw-bold fs-15">Clients au cabinet</span>
									<!--end::Subtitle-->
								</div>
								<!--end::Title-->
							</div>
							<!--end::Header-->
							<!--begin::Card body-->
							<div class="card-body pt-5 d-flex flex-wrap align-items-center">
								<!--begin::Chart-->
								...
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
									...
									<div class="d-flex fw-semibold align-items-center">
										...
										<!--end::Label-->
										<!--begin::Stats-->
										<div class="fw-bolder text-gray-700 text-xxl-end">50</div>
										<!--end::Stats-->
									</div>
									<!--end::Label-->
									<!--begin::Label-->
					...
					<div class="col-md-4 col-lg-3 mb-5 mb-lg-0">
						...
						<div class="card card-flush min-h-225px">
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									<!--begin::Subtitle-->
									<span class="text-dark pt-1 fw-bold fs-15">Chiffre d'affaire DEC</span>
									<!--end::Subtitle-->
								</div>
								<!--end::Title-->
								<!--begin::Toolbar-->
					...
					<div class="col-md-4 col-lg-3 mb-5 mb-lg-0">
						...
						<div class="card card-flush min-h-225px">
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									<!--begin::Subtitle-->
									<span class="text-dark pt-1 fw-bold fs-15">Chiffre d'affaire DAC</span>
									<!--end::Subtitle-->
								</div>
								<!--end::Title-->
								<!--begin::Toolbar-->
					...
					<div class="col-md-4 col-lg-3 mb-5 mb-lg-0">
						...
						<div class="card card-flush min-h-225px">
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									<!--begin::Subtitle-->
									<span class="text-dark pt-1 fw-bold fs-15">Chiffre d'affaire DC</span>
									<!--end::Subtitle-->
								</div>
								<!--end::Title-->
								<!--begin::Toolbar-->
							...
							<div class="card-body d-flex flex-column">
								...
								<div class="mt-5">
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-senter">
											<!--begin::Number-->
											<span class="text-gray-900 fw-bolder fs-6"> clients à jour</span>
											<!--end::Number-->
										</div>
										<!--end::Statistics-->
									</div>
