                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a id="nom_prenom_collaborateur" href="roll/dd/collaborateurs/view" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">--</a>
                                        </div>
                                        <!--end::Name-->
                                        <!--begin::Info-->
...
<script>
    $(document).ready(function() {
        ...
        function reload_datatable(datatable) {
            $.ajax({
                url: "roll/dd/collaborateurs/fetch.php",
                method: "POST",
                data: {
                    datatable: datatable,
                },
