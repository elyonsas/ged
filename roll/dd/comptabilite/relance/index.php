...
<script>
    $(document).ready(function() {
        ...
        function reload_page() {
            ...
            $.ajax({
                url: "roll/dd/comptabilite/relance/fetch.php",
                method: "POST",
                data: {
