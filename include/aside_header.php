...
<div id="kt_aside" class="aside bg-primary" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
        ...
        <div class="hover-scroll-overlay-y my-2 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="5px">
            ...
            <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-6" data-kt-menu="true">
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Tous les articles', 'fournisseur/articles/all', $menu_articles_all],

                        [
                            'Article disponibles',

                            [
                                ['Articles publics', 'fournisseur/articles/dispo_public', $menu_articles_dispo_public],
                                ['Articles privés', 'fournisseur/articles/dispo_prive', $menu_articles_dispo_prive],
                                ['Commandes d\'équipe', 'fournisseur/articles/dispo_equipe', $menu_articles_dispo_equipe]
                            ],
                        ...
                        [
                            ...
                            [
                                ['Public', 'fournisseur/articles/add_public', $menu_articles_add_public],
                                ['Privé', 'fournisseur/articles/add_prive', $menu_articles_add_prive],
                                ['D\'équipe', 'fournisseur/articles/add_equipe', $menu_articles_add_equipe]
                            ],
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Toutes les missions', 'fournisseur/missions/all', $menu_missions_all],

                        ['Missions en attentes', 'fournisseur/missions/en_attente', $menu_missions_en_attente],

                        ['Missions en cours', 'fournisseur/missions/en_cour', $menu_missions_en_cour],

                        ['Missions terminées', 'fournisseur/missions/termine', $menu_missions_termine],

                        ['Missions validées', 'fournisseur/missions/valide', $menu_missions_valide]
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Tous les clients', 'fournisseur/clients/all', $menu_clients_all],

                        ['Ajouter un client', 'fournisseur/clients/add', $menu_clients_add]
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Tous les rédacteurs', 'fournisseur/redacteurs/all', $menu_redacteurs_all],

                        ['Ajouter un rédacteur', 'fournisseur/redacteurs/add', $menu_redacteurs_add]
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Tous les correcteurs', 'fournisseur/correcteurs/all', $menu_correcteurs_all],

                        ['Ajouter un correcteur', 'fournisseur/correcteurs/add', $menu_correcteurs_add]
                ...
                <?= single_sub_menu(
                    ...
                    $icon,
                    [
                        ['Toutes les équipes', 'fournisseur/equipes/all', $menu_equipes_all],

                        ['Ajouter une équipe', 'fournisseur/equipes/add', $menu_equipes_add]
    ...
    <div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
        <!--begin::Menu-->
        <div class="mb-7">
            <button type="button" class="btn btm-sm btn-custom btn-icon" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Paramètres">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content fs-6 text-dark fw-bold px-3 py-4">Paramètres</div>
                </div>
                <!--end::Menu item-->
        ...
        <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center" id="kt_header_wrapper">
                ...
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                    <!--begin::Heading-->
                    <h1 class="text-dark fw-bold my-1 fs-3 lh-1"><?= $titre_menu ?></h1>
                    <!--end::Heading-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-stretch justify-self-end flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            <img src="assets/media/avatars/<?= user('avatar') ?>" alt="user">
                        </div>
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="assets/media/avatars/<?= user('avatar') ?>">
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
