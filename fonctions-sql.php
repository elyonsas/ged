<?php
    ...
    function select_all_dossiers_collabo($id_collabo, PDO $db){
        ...
        AND collaborateur.id_collaborateur = assoc_client_collabo.id_collaborateur AND collaborateur.id_collaborateur = :id_collabo";
